...
Command: `bash .claude/skills/scaffold-tests/scripts/verify-tests.sh --app {app} --target {target} --format json`
...
`.claude/rules/testing.md` -> "The real baseline" updated with one line for `{test_file}`.
